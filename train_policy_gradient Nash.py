...
def train_policy_gradients(game_spec,
    ...
    with tf.Session() as session:
        ...
        def make_training_move_2(board_state, side):
            ...
            move = get_stochastic_network_move(session, input_layer_2, output_layer_2, board_state, side)
        ...
        for episode_number in range(1, number_of_games):
            ...
            #    opponent_func = make_training_move
            ...
            if (not randomize_first_player) or bool(random.getrandbits(1)):
                reward = game_spec.play_game(make_training_move, make_training_move_2, log = log_)
                reward_2 = - reward
            else:
